...
// tau DNN-based ID
vector<float>  tau_byDeepTau2017v2p1VSjetRAW_;
...
vector<float>  tau_byDeepTau2017v2p1VSeRAW_;
...
vector<float>  tau_byDeepTau2017v2p1VSmuRAW_;
...
//  tree->Branch("tau_LeadChargedHadronExists",                           &tau_LeadChargedHadronExists_);
  ...
  // tau DNN-based ID
  tree->Branch("tau_byDeepTau2017v2p1VSjetRAW",         &tau_byDeepTau2017v2p1VSjetRAW_);
  ...
  tree->Branch("tau_byDeepTau2017v2p1VSeRAW",         &tau_byDeepTau2017v2p1VSeRAW_);
  ...
  tree->Branch("tau_byDeepTau2017v2p1VSmuRAW",         &tau_byDeepTau2017v2p1VSmuRAW_);
...
void phoJetNtuplizer::fillTaus (const edm::Event& iEvent){
  ...
  for(vector<pat::Tau>::const_iterator itau = tauHandle->begin(); itau != tauHandle->end(); ++itau) {
    ...
    // tau DNN-based ID
    tau_byDeepTau2017v2p1VSjetRAW_                        .push_back(itau->tauID("byDeepTau2017v2p1VSjetraw"));
    ...
    tau_byDeepTau2017v2p1VSeRAW_                          .push_back(itau->tauID("byDeepTau2017v2p1VSeraw"));
    ...
    tau_byDeepTau2017v2p1VSmuRAW_                         .push_back(itau->tauID("byDeepTau2017v2p1VSmuraw"));
...
void phoJetNtuplizer::initTaus(){
  ...
  // tau DNN-based ID
  tau_byDeepTau2017v2p1VSjetRAW_                        .clear();
  ...
  tau_byDeepTau2017v2p1VSeRAW_                          .clear();
  ...
  tau_byDeepTau2017v2p1VSmuRAW_                         .clear();
