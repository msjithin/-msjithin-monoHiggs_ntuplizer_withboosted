...
phoJetNtuplizer = cms.EDAnalyzer('phoJetNtuplizer',
								  ...
								  dumpBoostedTaus                      = cms.bool(True), # for boosted taus
				...
				boostedTauSrc             = cms.InputTag("slimmedTausBoosted"), # for boosted taus
			    cleanedBoostedTauSrc    = cms.InputTag("slimmedBoostedTausNewID"), # for boosted taus
